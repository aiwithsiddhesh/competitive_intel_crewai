...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"competitor_research_node": {"type": "listen", "trigger_methods": ["initialize_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "competitor_research_node", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(initialize_research)\n    def competitor_research_node(self) -> None:\n        result = CompetitorResearchCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"competitors\": \", \".join(self.state.competitors),\n            }\n        )\n        self.state.competitor_data = result.raw\n", "source_lines": ["    @listen(initialize_research)\n", "    def competitor_research_node(self) -> None:\n", "        result = CompetitorResearchCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"competitors\": \", \".join(self.state.competitors),\n", "            }\n", "        )\n", "        self.state.competitor_data = result.raw\n"], "source_start_line": 33, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "finalize_report": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["generate_strategy_report", "generate_defense_report"]}, "trigger_methods": ["generate_strategy_report", "generate_defense_report"], "method_signature": {"operationId": "finalize_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(or_(generate_strategy_report, generate_defense_report))\n    def finalize_report(self) -> None:\n        result = ReviewCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"competitors\": \", \".join(self.state.competitors),\n                \"strategy_report\": self.state.strategy_report,\n            }\n        )\n        self.state.final_report = result.pydantic\n", "source_lines": ["    @listen(or_(generate_strategy_report, generate_defense_report))\n", "    def finalize_report(self) -> None:\n", "        result = ReviewCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"competitors\": \", \".join(self.state.competitors),\n", "                \"strategy_report\": self.state.strategy_report,\n", "            }\n", "        )\n", "        self.state.final_report = result.pydantic\n"], "source_start_line": 103, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "generate_defense_report": {"type": "listen", "trigger_methods": ["competitive_threat"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "generate_defense_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(\"competitive_threat\")\n    def generate_defense_report(self) -> None:\n        result = StrategyCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"market_data\": self.state.market_data,\n                \"competitor_data\": self.state.competitor_data,\n            }\n        )\n        self.state.strategy_report = result.raw\n", "source_lines": ["    @listen(\"competitive_threat\")\n", "    def generate_defense_report(self) -> None:\n", "        result = StrategyCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"market_data\": self.state.market_data,\n", "                \"competitor_data\": self.state.competitor_data,\n", "            }\n", "        )\n", "        self.state.strategy_report = result.raw\n"], "source_start_line": 91, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "generate_strategy_report": {"type": "listen", "trigger_methods": ["growth_opportunity"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "generate_strategy_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(\"growth_opportunity\")\n    def generate_strategy_report(self) -> None:\n        result = StrategyCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"market_data\": self.state.market_data,\n                \"competitor_data\": self.state.competitor_data,\n            }\n        )\n        self.state.strategy_report = result.raw\n", "source_lines": ["    @listen(\"growth_opportunity\")\n", "    def generate_strategy_report(self) -> None:\n", "        result = StrategyCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"market_data\": self.state.market_data,\n", "                \"competitor_data\": self.state.competitor_data,\n", "            }\n", "        )\n", "        self.state.strategy_report = result.raw\n"], "source_start_line": 79, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "initialize_research": {"type": "start", "method_signature": {"operationId": "initialize_research", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @start()\n    def initialize_research(self) -> None:\n        print(f\"\\n{'='*60}\")\n        print(f\"Starting Competitive Intelligence Analysis\")\n        print(f\"Company:     {self.state.company_name}\")\n        print(f\"Industry:    {self.state.industry}\")\n        print(f\"Competitors: {', '.join(self.state.competitors)}\")\n        print(f\"{'='*60}\\n\")\n", "source_lines": ["    @start()\n", "    def initialize_research(self) -> None:\n", "        print(f\"\\n{'='*60}\")\n", "        print(f\"Starting Competitive Intelligence Analysis\")\n", "        print(f\"Company:     {self.state.company_name}\")\n", "        print(f\"Industry:    {self.state.industry}\")\n", "        print(f\"Competitors: {', '.join(self.state.competitors)}\")\n", "        print(f\"{'='*60}\\n\")\n"], "source_start_line": 14, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "market_research_node": {"type": "listen", "trigger_methods": ["initialize_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "market_research_node", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(initialize_research)\n    def market_research_node(self) -> None:\n        result = MarketResearchCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n            }\n        )\n        self.state.market_data = result.raw\n", "source_lines": ["    @listen(initialize_research)\n", "    def market_research_node(self) -> None:\n", "        result = MarketResearchCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "            }\n", "        )\n", "        self.state.market_data = result.raw\n"], "source_start_line": 23, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "route_by_sentiment": {"type": "router", "is_router": true, "router_paths": ["competitive_threat", "growth_opportunity"], "trigger_methods": ["synthesize_insights"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "route_by_sentiment", "parameters": {}, "returns": {"type": "object", "className": "Literal"}}, "source_code": "    @router(synthesize_insights)\n    def route_by_sentiment(self) -> Literal[\"growth_opportunity\", \"competitive_threat\"]:\n        print(f\"\\nRouting on sentiment: {self.state.synthesis.market_sentiment}\")\n        if self.state.synthesis.market_sentiment == \"growth\":\n            return \"growth_opportunity\"\n        return \"competitive_threat\"\n", "source_lines": ["    @router(synthesize_insights)\n", "    def route_by_sentiment(self) -> Literal[\"growth_opportunity\", \"competitive_threat\"]:\n", "        print(f\"\\nRouting on sentiment: {self.state.synthesis.market_sentiment}\")\n", "        if self.state.synthesis.market_sentiment == \"growth\":\n", "            return \"growth_opportunity\"\n", "        return \"competitive_threat\"\n"], "source_start_line": 72, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "synthesize_insights": {"type": "listen", "trigger_methods": ["market_research_node", "competitor_research_node"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["market_research_node", "competitor_research_node"]}, "method_signature": {"operationId": "synthesize_insights", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(and_(market_research_node, competitor_research_node))\n    def synthesize_insights(self) -> None:\n        synthesis_agent = Agent(\n            role=f\"Strategic Intelligence Synthesizer for {self.state.industry}\",\n            goal=(\n                \"Synthesize market research and competitor analysis into a structured strategic brief. \"\n                \"Classify market sentiment as exactly 'growth' or 'competitive' with a one-sentence justification.\"\n            ),\n            backstory=(\n                \"You are a strategy consultant who distills complex, multi-source data into executive-ready insights. \"\n                \"You always commit to a definitive sentiment classification backed by evidence from the provided research.\"\n            ),\n            verbose=True,\n        )\n\n        prompt = (\n            f\"Analyze the following research for {self.state.company_name} \"\n            f\"in the {self.state.industry} industry and produce a structured strategic synthesis.\\n\\n\"\n            f\"MARKET RESEARCH:\\n{self.state.market_data}\\n\\n\"\n            f\"COMPETITOR ANALYSIS:\\n{self.state.competitor_data}\\n\\n\"\n            f\"Extract 5-7 key strategic insights, classify market sentiment as 'growth' \"\n            f\"(fast-growing, whitespace, first-mover opportunity) or 'competitive' \"\n            f\"(saturated, differentiation required), and write a strategic summary paragraph.\"\n        )\n\n        result = synthesis_agent.kickoff(prompt, response_format=SynthesisOutput).pydantic\n        self.state.synthesis = result\n", "source_lines": ["    @listen(and_(market_research_node, competitor_research_node))\n", "    def synthesize_insights(self) -> None:\n", "        synthesis_agent = Agent(\n", "            role=f\"Strategic Intelligence Synthesizer for {self.state.industry}\",\n", "            goal=(\n", "                \"Synthesize market research and competitor analysis into a structured strategic brief. \"\n", "                \"Classify market sentiment as exactly 'growth' or 'competitive' with a one-sentence justification.\"\n", "            ),\n", "            backstory=(\n", "                \"You are a strategy consultant who distills complex, multi-source data into executive-ready insights. \"\n", "                \"You always commit to a definitive sentiment classification backed by evidence from the provided research.\"\n", "            ),\n", "            verbose=True,\n", "        )\n", "\n", "        prompt = (\n", "            f\"Analyze the following research for {self.state.company_name} \"\n", "            f\"in the {self.state.industry} industry and produce a structured strategic synthesis.\\n\\n\"\n", "            f\"MARKET RESEARCH:\\n{self.state.market_data}\\n\\n\"\n", "            f\"COMPETITOR ANALYSIS:\\n{self.state.competitor_data}\\n\\n\"\n", "            f\"Extract 5-7 key strategic insights, classify market sentiment as 'growth' \"\n", "            f\"(fast-growing, whitespace, first-mover opportunity) or 'competitive' \"\n", "            f\"(saturated, differentiation required), and write a strategic summary paragraph.\"\n", "        )\n", "\n", "        result = synthesis_agent.kickoff(prompt, response_format=SynthesisOutput).pydantic\n", "        self.state.synthesis = result\n"], "source_start_line": 44, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}};
...
class NetworkManager {
  ...
  async initialize() {
    try {
      ...
      this.nodes = new vis.DataSet([{"id": "competitor_research_node", "label": "competitor_research_node", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">competitor_research_node</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">initialize_research</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 1, "nodeStyle": {"name": "competitor_research_node", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "finalize_report", "label": "finalize_report", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">finalize_report</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">generate_strategy_report</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">generate_defense_report</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 5, "nodeStyle": {"name": "finalize_report", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "generate_defense_report", "label": "generate_defense_report", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">generate_defense_report</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">competitive_threat</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 4, "nodeStyle": {"name": "generate_defense_report", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "generate_strategy_report", "label": "generate_strategy_report", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">generate_strategy_report</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">growth_opportunity</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 4, "nodeStyle": {"name": "generate_strategy_report", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "initialize_research", "label": "initialize_research", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">initialize_research</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">start</span>\n            </div>\n        ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "initialize_research", "bgColor": "var(--node-bg-start)", "borderColor": "var(--node-border-start)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "market_research_node", "label": "market_research_node", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">market_research_node</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">initialize_research</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 1, "nodeStyle": {"name": "market_research_node", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "route_by_sentiment", "label": "route_by_sentiment", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">route_by_sentiment</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">synthesize_insights</code></li></ul>\n                </div>\n            \n                <div>\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Router Paths</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">competitive_threat</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">growth_opportunity</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 3, "nodeStyle": {"name": "route_by_sentiment", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "synthesize_insights", "label": "synthesize_insights", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">synthesize_insights</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(255,90,80,0.12); color: #FF5A50; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">AND</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">market_research_node</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">competitor_research_node</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 2, "nodeStyle": {"name": "synthesize_insights", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}]);
      this.edges = new vis.DataSet([{"from": "initialize_research", "to": "market_research_node", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "initialize_research", "to": "competitor_research_node", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "market_research_node", "to": "synthesize_insights", "label": "AND", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}}, {"from": "competitor_research_node", "to": "synthesize_insights", "label": "AND", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}}, {"from": "generate_strategy_report", "to": "finalize_report", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "generate_defense_report", "to": "finalize_report", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "synthesize_insights", "to": "route_by_sentiment", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "route_by_sentiment", "to": "generate_defense_report", "label": "competitive_threat", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "route_by_sentiment", "to": "generate_strategy_report", "label": "growth_opportunity", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}]);
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"competitor_research_node": {"type": "listen", "trigger_methods": ["initialize_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "competitor_research_node", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(initialize_research)\n    def competitor_research_node(self) -> None:\n        result = CompetitorResearchCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"competitors\": \", \".join(self.state.competitors),\n            }\n        )\n        self.state.competitor_data = result.raw\n", "source_lines": ["    @listen(initialize_research)\n", "    def competitor_research_node(self) -> None:\n", "        result = CompetitorResearchCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"competitors\": \", \".join(self.state.competitors),\n", "            }\n", "        )\n", "        self.state.competitor_data = result.raw\n"], "source_start_line": 33, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "finalize_report": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["generate_strategy_report", "generate_defense_report"]}, "trigger_methods": ["generate_strategy_report", "generate_defense_report"], "method_signature": {"operationId": "finalize_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(or_(generate_strategy_report, generate_defense_report))\n    def finalize_report(self) -> None:\n        result = ReviewCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"competitors\": \", \".join(self.state.competitors),\n                \"strategy_report\": self.state.strategy_report,\n            }\n        )\n        self.state.final_report = result.pydantic\n", "source_lines": ["    @listen(or_(generate_strategy_report, generate_defense_report))\n", "    def finalize_report(self) -> None:\n", "        result = ReviewCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"competitors\": \", \".join(self.state.competitors),\n", "                \"strategy_report\": self.state.strategy_report,\n", "            }\n", "        )\n", "        self.state.final_report = result.pydantic\n"], "source_start_line": 103, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "generate_defense_report": {"type": "listen", "trigger_methods": ["competitive_threat"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "generate_defense_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(\"competitive_threat\")\n    def generate_defense_report(self) -> None:\n        result = StrategyCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"market_data\": self.state.market_data,\n                \"competitor_data\": self.state.competitor_data,\n            }\n        )\n        self.state.strategy_report = result.raw\n", "source_lines": ["    @listen(\"competitive_threat\")\n", "    def generate_defense_report(self) -> None:\n", "        result = StrategyCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"market_data\": self.state.market_data,\n", "                \"competitor_data\": self.state.competitor_data,\n", "            }\n", "        )\n", "        self.state.strategy_report = result.raw\n"], "source_start_line": 91, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "generate_strategy_report": {"type": "listen", "trigger_methods": ["growth_opportunity"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "generate_strategy_report", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(\"growth_opportunity\")\n    def generate_strategy_report(self) -> None:\n        result = StrategyCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n                \"market_data\": self.state.market_data,\n                \"competitor_data\": self.state.competitor_data,\n            }\n        )\n        self.state.strategy_report = result.raw\n", "source_lines": ["    @listen(\"growth_opportunity\")\n", "    def generate_strategy_report(self) -> None:\n", "        result = StrategyCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "                \"market_data\": self.state.market_data,\n", "                \"competitor_data\": self.state.competitor_data,\n", "            }\n", "        )\n", "        self.state.strategy_report = result.raw\n"], "source_start_line": 79, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "initialize_research": {"type": "start", "method_signature": {"operationId": "initialize_research", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @start()\n    def initialize_research(self) -> None:\n        print(f\"\\n{'='*60}\")\n        print(f\"Starting Competitive Intelligence Analysis\")\n        print(f\"Company:     {self.state.company_name}\")\n        print(f\"Industry:    {self.state.industry}\")\n        print(f\"Competitors: {', '.join(self.state.competitors)}\")\n        print(f\"{'='*60}\\n\")\n", "source_lines": ["    @start()\n", "    def initialize_research(self) -> None:\n", "        print(f\"\\n{'='*60}\")\n", "        print(f\"Starting Competitive Intelligence Analysis\")\n", "        print(f\"Company:     {self.state.company_name}\")\n", "        print(f\"Industry:    {self.state.industry}\")\n", "        print(f\"Competitors: {', '.join(self.state.competitors)}\")\n", "        print(f\"{'='*60}\\n\")\n"], "source_start_line": 14, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "market_research_node": {"type": "listen", "trigger_methods": ["initialize_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "market_research_node", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(initialize_research)\n    def market_research_node(self) -> None:\n        result = MarketResearchCrew().crew().kickoff(\n            inputs={\n                \"company_name\": self.state.company_name,\n                \"industry\": self.state.industry,\n            }\n        )\n        self.state.market_data = result.raw\n", "source_lines": ["    @listen(initialize_research)\n", "    def market_research_node(self) -> None:\n", "        result = MarketResearchCrew().crew().kickoff(\n", "            inputs={\n", "                \"company_name\": self.state.company_name,\n", "                \"industry\": self.state.industry,\n", "            }\n", "        )\n", "        self.state.market_data = result.raw\n"], "source_start_line": 23, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "route_by_sentiment": {"type": "router", "is_router": true, "router_paths": ["competitive_threat", "growth_opportunity"], "trigger_methods": ["synthesize_insights"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "route_by_sentiment", "parameters": {}, "returns": {"type": "object", "className": "Literal"}}, "source_code": "    @router(synthesize_insights)\n    def route_by_sentiment(self) -> Literal[\"growth_opportunity\", \"competitive_threat\"]:\n        print(f\"\\nRouting on sentiment: {self.state.synthesis.market_sentiment}\")\n        if self.state.synthesis.market_sentiment == \"growth\":\n            return \"growth_opportunity\"\n        return \"competitive_threat\"\n", "source_lines": ["    @router(synthesize_insights)\n", "    def route_by_sentiment(self) -> Literal[\"growth_opportunity\", \"competitive_threat\"]:\n", "        print(f\"\\nRouting on sentiment: {self.state.synthesis.market_sentiment}\")\n", "        if self.state.synthesis.market_sentiment == \"growth\":\n", "            return \"growth_opportunity\"\n", "        return \"competitive_threat\"\n"], "source_start_line": 72, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}, "synthesize_insights": {"type": "listen", "trigger_methods": ["market_research_node", "competitor_research_node"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["market_research_node", "competitor_research_node"]}, "method_signature": {"operationId": "synthesize_insights", "parameters": {}, "returns": {"type": "null"}}, "source_code": "    @listen(and_(market_research_node, competitor_research_node))\n    def synthesize_insights(self) -> None:\n        synthesis_agent = Agent(\n            role=f\"Strategic Intelligence Synthesizer for {self.state.industry}\",\n            goal=(\n                \"Synthesize market research and competitor analysis into a structured strategic brief. \"\n                \"Classify market sentiment as exactly 'growth' or 'competitive' with a one-sentence justification.\"\n            ),\n            backstory=(\n                \"You are a strategy consultant who distills complex, multi-source data into executive-ready insights. \"\n                \"You always commit to a definitive sentiment classification backed by evidence from the provided research.\"\n            ),\n            verbose=True,\n        )\n\n        prompt = (\n            f\"Analyze the following research for {self.state.company_name} \"\n            f\"in the {self.state.industry} industry and produce a structured strategic synthesis.\\n\\n\"\n            f\"MARKET RESEARCH:\\n{self.state.market_data}\\n\\n\"\n            f\"COMPETITOR ANALYSIS:\\n{self.state.competitor_data}\\n\\n\"\n            f\"Extract 5-7 key strategic insights, classify market sentiment as 'growth' \"\n            f\"(fast-growing, whitespace, first-mover opportunity) or 'competitive' \"\n            f\"(saturated, differentiation required), and write a strategic summary paragraph.\"\n        )\n\n        result = synthesis_agent.kickoff(prompt, response_format=SynthesisOutput).pydantic\n        self.state.synthesis = result\n", "source_lines": ["    @listen(and_(market_research_node, competitor_research_node))\n", "    def synthesize_insights(self) -> None:\n", "        synthesis_agent = Agent(\n", "            role=f\"Strategic Intelligence Synthesizer for {self.state.industry}\",\n", "            goal=(\n", "                \"Synthesize market research and competitor analysis into a structured strategic brief. \"\n", "                \"Classify market sentiment as exactly 'growth' or 'competitive' with a one-sentence justification.\"\n", "            ),\n", "            backstory=(\n", "                \"You are a strategy consultant who distills complex, multi-source data into executive-ready insights. \"\n", "                \"You always commit to a definitive sentiment classification backed by evidence from the provided research.\"\n", "            ),\n", "            verbose=True,\n", "        )\n", "\n", "        prompt = (\n", "            f\"Analyze the following research for {self.state.company_name} \"\n", "            f\"in the {self.state.industry} industry and produce a structured strategic synthesis.\\n\\n\"\n", "            f\"MARKET RESEARCH:\\n{self.state.market_data}\\n\\n\"\n", "            f\"COMPETITOR ANALYSIS:\\n{self.state.competitor_data}\\n\\n\"\n", "            f\"Extract 5-7 key strategic insights, classify market sentiment as 'growth' \"\n", "            f\"(fast-growing, whitespace, first-mover opportunity) or 'competitive' \"\n", "            f\"(saturated, differentiation required), and write a strategic summary paragraph.\"\n", "        )\n", "\n", "        result = synthesis_agent.kickoff(prompt, response_format=SynthesisOutput).pydantic\n", "        self.state.synthesis = result\n"], "source_start_line": 44, "source_file": "E:\\dev\\proj\\study_crew_ai\\7_competitive_intel\\src\\competitive_intel\\flow.py", "class_signature": "class IntelligenceFlow(Flow[IntelligenceState])", "class_line_number": 12, "class_name": "IntelligenceFlow"}}, "edges": [{"source": "initialize_research", "target": "market_research_node", "condition_type": "OR", "is_router_path": false}, {"source": "initialize_research", "target": "competitor_research_node", "condition_type": "OR", "is_router_path": false}, {"source": "market_research_node", "target": "synthesize_insights", "condition_type": "AND", "is_router_path": false}, {"source": "competitor_research_node", "target": "synthesize_insights", "condition_type": "AND", "is_router_path": false}, {"source": "generate_strategy_report", "target": "finalize_report", "condition_type": "OR", "is_router_path": false}, {"source": "generate_defense_report", "target": "finalize_report", "condition_type": "OR", "is_router_path": false}, {"source": "synthesize_insights", "target": "route_by_sentiment", "condition_type": "OR", "is_router_path": false}, {"source": "route_by_sentiment", "target": "generate_defense_report", "condition_type": null, "is_router_path": true, "router_path_label": "competitive_threat"}, {"source": "route_by_sentiment", "target": "generate_strategy_report", "condition_type": null, "is_router_path": true, "router_path_label": "growth_opportunity"}], "start_methods": ["initialize_research"], "router_methods": ["route_by_sentiment"]};
